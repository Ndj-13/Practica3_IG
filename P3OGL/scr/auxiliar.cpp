...
char *loadStringFromFile(const char *fileName, unsigned int &fileLen) //devuelve alto y ancho y propiedades
{
	//Se carga el fichero
	std::ifstream file;
...
unsigned char *loadTexture(const char* fileName, unsigned int &w, unsigned int &h) //devuelve numero de caracteres y una cdena con todos los caracteres --> lo usamos para cargar shaders
{
